				...
				<div class="table-responsive-sm mt-3 mb-3">
					<table class="table table-sm table-striped table-hover">
						...
						<tbody>
							<tr>
								<th>Admin.php</th>
								<td class="text-wrap">If your module has an admin area, the easiest way is to create this controller. Link to it will be listed under the <code>Components</code> menu dropdown. This controller should extend <code>Admin_Controller</code> class.</td>
							</tr>
							<tr>
								<th>Content.php</th>
								<td class="text-wrap">Extends the <code>Content_Controller</code> class. If your module is meant to manage any type of content, it is better to create this controller instead of <code>Admin.php</code>. Link to the module will be listed under the <code>Content</code> menu dropdown.</td>
							</tr>
							<tr>
								<th>Help.php</th>
								<td class="text-wrap">If you provide an internal documentation section for your module, simply create this controller and its views. This should extend the <code>Help_Controller</code> class and its link will be displayed under the <code>Help</code> dropdown menu.</td>
							</tr>
							<tr>
								<th>Reports.php</th>
